...
import com.example.myblog2.security.jwt.HeaderTokenExtractor;
import com.example.myblog2.security.jwt.JwtPreProcessingToken;
...
public class JwtFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        JwtPreProcessingToken jwtToken = new JwtPreProcessingToken(
                headerTokenExtractor.extract(tokenPayload, request));
    ...
    protected void successfulAuthentication(
         ...
         */
        System.out.println("JwtFilter Successful Handeler");
    ...
    protected void unsuccessfulAuthentication(
         ...
         */
        System.out.println("JwtFilter Unsuccessful Handeler");
